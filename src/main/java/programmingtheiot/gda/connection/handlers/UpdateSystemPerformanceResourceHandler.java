        ...
        if (this.dataMsgListener != null) {
            try {
                ...
                SystemPerformanceData sysPerfData =
                    programmingtheiot.data.DataUtil.getInstance().jsonToSystemPerformanceData(jsonData);

                this.dataMsgListener.handleSystemPerformanceMessage(
                    programmingtheiot.common.ResourceNameEnum.CDA_SYSTEM_PERF_MSG_RESOURCE, sysPerfData);
